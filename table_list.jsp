    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <%
                ...
                if (date == null || date_start == null || date_end == null || number == null)
                    sql = "select * from `tables`";
                else {
                    String sql1 = "SELECT T_id FROM reservation WHERE reservation.R_date = '" + date + "' and ";
                    String sql2 = "reservation.R_time_start > '" + date_start + "'OR reservation.R_time_end < '"
                    + date_end + "')";
                    sql = "SELECT distinct * FROM `tables`T WHERE T.places >= " + number + " and T.table_id not IN ("
                            +sql1 + sql2;
