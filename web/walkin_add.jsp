...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="table_list.jsp" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="commentdatemax" name="r_end_time" class="input-text Wdate">
            </div>
        </div>
