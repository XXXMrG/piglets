...
<div class="page-container">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <tbody>
            <jsp:useBean id="reservation1" scope="request" class="bean.ReservationList"></jsp:useBean>

            <%
                String id = request.getParameter("table_id");
                reservation1.setTable_r(id);
                //System.out.print(request.getParameter("table_id"));
                ArrayList list = reservation1.getTable_r();
