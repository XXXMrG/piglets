    ...
    <form class="form form-horizontal" id="form-admin-add" >
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="adminID" name="adminID">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
			...
			<select class="select" name="adminRole" size="1">
				...
				<option value="1">领班</option>
				<option value="2">接待员</option>
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    ...
                    success: function(data){
                        layer.msg('注册成功!, 两秒后跳转回登陆页面',{icon:1,time:1000});
                        window.setTimeout("window.location='login.jsp'",2000);
                    },
                    error: function(XmlHttpRequest, textStatus, errorThrown){
                        layer.msg('error! 请检查数据是否重复',{icon:1,time:1000});
                    }
                });
